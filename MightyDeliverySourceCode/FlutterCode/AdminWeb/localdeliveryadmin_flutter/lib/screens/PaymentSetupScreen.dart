...
//   static String route = '/admin/paymentSetup';
//
//   final String? paymentType;
//
//   PaymentSetupScreen({this.paymentType});
//
//   @override
...
//
//   String selectedPaymentType = PAYMENT_TYPE_STRIPE;
//   int? isTest;
//   bool isUpdate = false;
...
//                             ),
//                             SizedBox(height: 16),
//                             if (selectedPaymentType == PAYMENT_TYPE_STRIPE) stripeForm(),
//                             if (selectedPaymentType == PAYMENT_TYPE_RAZORPAY) razorPayForm(),
//                             if (selectedPaymentType == PAYMENT_TYPE_PAYSTACK) payStackForm(),
//                             if (selectedPaymentType == PAYMENT_TYPE_FLUTTERWAVE) flutterWaveForm(),
//                             if (selectedPaymentType == PAYMENT_TYPE_PAYPAL) payPalForm(),
//                             if (selectedPaymentType == PAYMENT_TYPE_PAYTABS) payTabsForm(),
//                             if (selectedPaymentType == PAYMENT_TYPE_MERCADOPAGO) mercadoPagoForm(),
//                             if (selectedPaymentType == PAYMENT_TYPE_PAYTM) paytmForm(),
//                             if (selectedPaymentType == PAYMENT_TYPE_MYFATOORAH) myFatoorahForm(),
//                             SizedBox(height: 16),
//                             Row(
//                               children: [
