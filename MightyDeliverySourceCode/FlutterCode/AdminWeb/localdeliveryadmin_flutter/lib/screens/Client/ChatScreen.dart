...
class ChatScreenState extends State<ChatScreen> {
  ...
  void init() async {
    await getUserDetail(widget.userId.validate()).then((value) {
      receiverUser = value;
    }).catchError((e){});
    id = getStringAsync(UID);

    chatMessageService = ChatMessageService();
    chatMessageService.setUnReadStatusToTrue(senderId: sender.uid!, receiverId: receiverUser!.uid!);
    setState(() {});
  }
    ...
    return Scaffold(
      ...
      body: Observer(builder: (context) {
        return Column(
          children: [
            HeaderWidget(),
            if(receiverUser!=null) Container(
                    ...
                    children: [
                      Container(
                        ...
                        child: PaginateFirestore(
                          ...
                          query: chatMessageService.chatMessagesWithPagination(currentUserId: getStringAsync(UID), receiverUserId: receiverUser!.uid!),
