...
import '../../utils/Extensions/rich_text_widget.dart';
            ...
            if (value.data!.userType != CLIENT) {
              ...
              if (getIntAsync(USER_STATUS) == 1) {
                if (value.data!.countryId != null && value.data!.cityId != null) {
                  await getCountryDetailApiCall(value.data!.countryId.validate(), context);
                  await getCityDetailApiCall(value.data!.cityId.validate(), context);
                } else {
                  await showDialog(
                      context: getContext,
                      builder: (_) {
                  ...
                  list: [
                    ...
                    TextSpan(
                      ...
                      recognizer: TapGestureRecognizer()
                        ..onTap = () {
                          launchUrlWidget(builderResponse.termAndCondition.validate());
                        },
                    ),
                    ...
                    TextSpan(
                      ...
                      recognizer: TapGestureRecognizer()
                        ..onTap = () {
                          launchUrlWidget(builderResponse.privacyPolicy.validate());
                        },
                    ),
                  ],
                ),
              ...
              InkWell(
                onTap: () {
                  ...
                  if (appStore.isLoggedIn && (getStringAsync(USER_TYPE) == ADMIN || getStringAsync(USER_TYPE) == DEMO_ADMIN)) {
                    Navigator.pushNamed(context, AdminHomeWidget.route);
                  } else {
