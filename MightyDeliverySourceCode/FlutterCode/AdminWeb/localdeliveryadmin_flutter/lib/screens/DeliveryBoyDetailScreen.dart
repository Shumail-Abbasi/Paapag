...
class _DeliveryPersonDetailScreenState extends State<DeliveryPersonDetailScreen> {
  ...
  commonWidget({String? title, var value}) {
    return Container(
      decoration: boxDecorationWithRoundedCorners(backgroundColor: context.cardColor, border: Border.all(width: 0.9, color: context.dividerColor), borderRadius: radius(16)),
                    ...
                    ResponsiveWidget.isLargeScreen(context) || ResponsiveWidget.isMediumScreen(context)
                        ? Row(
                            children: [
                              ...
                              outlineActionIcon(userData!.deletedAt == null ? Icons.edit : Icons.restore, Colors.green, '${userData!.deletedAt == null ? language.edit : language.restore}', () {
                                userData!.deletedAt == null
                                    ...
                                    : commonConfirmationDialog(context, DIALOG_TYPE_RESTORE, () {
                                        ...
                                        title: userData!.userType == CLIENT ? language.restore_user : language.restore_delivery_person,
                                        subtitle: userData!.userType == CLIENT ? language.restore_user_msg : language.restore_delivery_person_msg);
                              }, title: '${userData!.deletedAt == null ? language.edit : language.restore}'),
                              16.width,
                              outlineActionIcon(
                                  userData!.deletedAt == null ? Icons.delete : Icons.delete_forever, Colors.red, '${userData!.deletedAt == null ? language.delete : language.force_delete}', () {
                              ...
                              }, title: '${userData!.deletedAt == null ? language.delete : language.force_delete}'),
                            ],
                          )
                        : Column(
                            crossAxisAlignment: CrossAxisAlignment.start,
                            children: [
                              ...
                              Row(
                                children: [
                                  ...
                                  8.width,
                                  outlineActionIcon(
                                    userData!.deletedAt == null ? Icons.delete : Icons.delete_forever,
                                    Colors.red,
                                    '${userData!.deletedAt == null ? language.delete : language.force_delete}',
                                    () {
                                      commonConfirmationDialog(context, DIALOG_TYPE_DELETE, () {
                                        if (shared_pref.getString(USER_TYPE) == DEMO_ADMIN) {
                                          toast(language.demo_admin_msg);
                                    ...
                                    userData!.isVerifiedDeliveryMan! == 1
                                        ...
                                        : SizedBox(
                                            ...
                                            child: ElevatedButton(
                                              onPressed: () async {
                                                Navigator.pushNamed(context, DeliveryPersonDocumentWidget.route + "?delivery_man_id=${userData!.id!}");
                                              },
                                  ...
                                  children: [
                                    ...
                                    if (earningList!.pagination!.totalItems!.toInt() > earningList!.pagination!.perPage!.toInt())
                                      paginationWidget(context,
                                          ...
                                          perPage: earningList!.pagination!.perPage!, onUpdate: (currentPageVal, perPageVal) {
