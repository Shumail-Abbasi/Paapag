...
const defaultCurrencySymbol = 'RS';
const defaultCurrencyCode = 'PKR  ';
...
const CREATE_ORDER_INDEX = 6;
const ORDER_INDEX = 7;
const DOCUMENT_INDEX = 8;
const DELIVERY_PERSON_DOCUMENT_INDEX = 9;
const USER_INDEX = 10;
const DELIVERY_PERSON_INDEX = 11;
const APP_SETTING_INDEX = 13;
const WITHDRAW_INDEX = 12;
