        ...
        child: AlertDialog(
          ...
          content: Container(
            ...
            child: Column(
              ...
              children: [
                Text(title ?? getTitle(dialogType), style: boldTextStyle(size: 18), textAlign: TextAlign.center),
                8.height.visible(subTitle.validate().isNotEmpty),
                Text(subTitle.validate(), style: secondaryTextStyle(size: 16), textAlign: TextAlign.center).visible(subTitle.validate().isNotEmpty),
                16.height,
                Row(
                  children: [
                    AppButton(
                      ...
                      child: Row(
                        ...
                        children: [
                          ...
                          6.width,
                          Text(negativeText ?? "Cancel", style: boldTextStyle(color: negativeTextColor ?? textPrimaryColorGlobal)),
                        ],
                      ).fit(),
                      onTap: () {
                    ...
                    AppButton(
                      ...
                      child: Row(
                        ...
                        children: [
                          getIcon(dialogType),
                          6.width,
                          Text(positiveText ?? getPositiveText(dialogType), style: boldTextStyle(color: positiveTextColor ?? Colors.white)),
                        ],
                      ).fit(),
                      onTap: () {
                        onAccept.call(_);
