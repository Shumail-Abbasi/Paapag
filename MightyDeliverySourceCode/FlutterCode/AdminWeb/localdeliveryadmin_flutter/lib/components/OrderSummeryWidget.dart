  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: [
        ...
        if ((widget.weightCharge != 0 || widget.distanceCharge != 0) && extraList.length != 0)
          Align(
            alignment: Alignment.bottomRight,
            child: Column(
              children: [
                SizedBox(height: 8),
                Text('${printAmount(double.parse((fixedCharges + widget.distanceCharge + widget.weightCharge).toStringAsFixed(digitAfterDecimal)))}', style: primaryTextStyle()),
              ],
            ),
          ),
