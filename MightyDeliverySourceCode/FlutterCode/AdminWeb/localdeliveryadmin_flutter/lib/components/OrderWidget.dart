...
import '../components/DeliveryOrderAssignWidget.dart';
import '../main.dart';
                                          ...
                                          cells: [
                                            ...
                                            DataCell(Text(
                                                ...
                                                style: primaryTextStyle(
                                                    color: e.deliveryManName == null && (e.status != ORDER_CREATE && e.status != ORDER_CANCELLED && e.status != ORDER_DRAFT) ? Colors.red : null))),
                                                  ...
                                                  ? (e.status == ORDER_COMPLETED || e.status == ORDER_CANCELLED || e.status == ORDER_DRAFT)
                                                      ...
                                                      : SizedBox(
                                                          ...
                                                          child: ElevatedButton(
                                                            ...
                                                            child: Text((e.status == ORDER_CREATE || e.deliveryManName == null) ? language.assign : language.transfer,
